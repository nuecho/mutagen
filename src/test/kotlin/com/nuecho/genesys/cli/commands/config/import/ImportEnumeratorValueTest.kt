...
class ImportEnumeratorValueTest : StringSpec() {
    ...
    init {
        ...
        "importing an existing EnumeratorValue should try to save it" {
            testImportConfigurationObject(false)
        }

        "importing a new EnumeratorValue should try to save it" {
